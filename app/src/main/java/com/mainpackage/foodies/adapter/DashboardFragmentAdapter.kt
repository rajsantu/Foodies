...
import com.mainpackage.foodies.activity.RestaurantMenuActivity
import com.mainpackage.foodies.database.RestaurantDatabase
import com.mainpackage.foodies.database.RestaurantEntity
import com.mainpackage.foodies.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, private var itemList: ArrayList<Restaurant>) :
    ...
    @SuppressLint("SetTextI18n", "IntentWithNullActionLaunch", "UseCompatLoadingForDrawables")
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        holder.txtPrice.text = restaurant.costForOne + "/Person"
