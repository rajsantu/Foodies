...
import com.mainpackage.foodies.adapter.CartAdapter
import com.mainpackage.foodies.model.CartItems
        ...
        btnPlaceOrder.setOnClickListener {
            ...
            if (ConnectionManager().checkConnectivity(this)) {
                ...
                try {
                    ...
                    val jsonObjectRequest = @SuppressLint("IntentWithNullActionLaunch")
                    object : JsonObjectRequest(
                        ...
                        Response.Listener {
                            ...
                            if (success) {
                                ...
                                val intent =
                                    Intent(this, OrderPlacedActivity::class.java)
                ...
                object : JsonObjectRequest(
                    ...
                    Response.Listener {
                        ...
                        if (success) {
                            ...
                            btnPlaceOrder.text = (R.string.place_order).toString() + totalAmount
